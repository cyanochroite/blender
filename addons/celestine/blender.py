...
class BOORU_mesh_delete(bpy.types.Operator):
    ...
    bl_idname = "celestine.mesh_delete"
...
class BOORU_main(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if not ready:
            ...
            self.layout.operator("celestine.mesh_delete")
            self.layout.operator("celestine.clear_all")
            self.layout.operator("celestine.checkers")
            #
            content = preferences.content()
